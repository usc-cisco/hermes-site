    ...
    return (
      <div className="fixed inset-0 z-0 flex flex-col bg-white lg:flex-row">
        ...
        <div
          ...
          style={{
            backgroundImage: "url('/logo-black.svg')",
        ...
        <div className="relative z-10 hidden flex-1 flex-col justify-center px-16 lg:flex">
          <div className="flex items-center gap-6">
            <img src="/logo-black.svg" alt="Hermes Logo" className="h-24 w-auto" />
            <div className="border-l-2 border-black pl-6">
              <p className="text-sm font-medium tracking-widest text-black">PROJECT</p>
              <h1 className="text-5xl font-black tracking-tight text-black">
                HERMES <sup className="text-lg">©</sup>
              </h1>
              <p className="mt-1 text-sm text-gray-600">An Open Source Initiative by DCISM Students &amp; CISCO.</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 flex flex-1 items-center justify-center px-4">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <div className="mb-6 flex items-center justify-center gap-3 lg:hidden">
              <img src="/logo-black.svg" alt="Hermes Logo" className="h-16 w-auto" />
              <h1 className="text-5xl font-black tracking-tight text-black">
