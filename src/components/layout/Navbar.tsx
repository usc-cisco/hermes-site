  ...
  return (
    <nav className="relative z-10 mb-4 px-6 py-4">
      <div className="flex items-center gap-2">
        <div className="group flex items-center gap-2 rounded-full border-2 border-black bg-black px-6 py-2 transition-colors hover:bg-transparent">
          <Link
            to="/"
            className="flex items-center text-lg font-semibold text-white transition-colors group-hover:text-black sm:text-xl"
          >
            <img src="/logo-white.svg" alt="Hermes Logo" className="mr-2 inline h-6 w-auto group-hover:hidden" />
            <img src="/logo-black.svg" alt="Hermes Logo" className="mr-2 hidden h-6 w-auto group-hover:inline" />
            HERMES
          </Link>
          <span className="text-sm text-gray-300 transition-colors group-hover:text-gray-600">| queue.dcism.org</span>
        </div>
