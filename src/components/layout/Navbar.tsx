  ...
  return (
    <nav className="relative z-10 mb-4 px-6 py-4">
      <div className="flex items-center gap-2">
        <Link
          to="/"
          className="group flex items-center gap-2 rounded-full border-2 border-primary bg-primary px-6 py-2 transition-colors hover:bg-transparent"
        >
          ...
          <span className="flex items-center text-lg font-semibold text-white transition-colors group-hover:text-primary sm:text-xl">
            HERMES
          </span>
          <span className="hidden text-sm text-blue-200 transition-colors group-hover:text-primary/60 lg:block">
            | queue.dcism.org
          </span>
        </Link>
